...
TEST_CASE("constexpr and_then choice", "[and_then][constexpr][choice]")
{
  ...
  WHEN("same value type")
  {
    ...
    static_assert(r3.invoke_to([](double i) -> int { return i; }) == 0.0);
  }
  ...
  WHEN("different value type")
  {
    ...
    static_assert(r1.invoke_to([](bool i) -> bool { return i; }) == true);
    constexpr auto r2 = T{0} | fn::and_then(fn);
    static_assert(r2.invoke_to([](bool i) -> bool { return i; }) == false);
    constexpr auto r3 = T{2} | fn::and_then(fn);
    static_assert(r3.invoke_to([](int i) -> int { return i; }) == 2);
  }
