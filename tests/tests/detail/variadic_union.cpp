...
TEST_CASE("variadic_union", "[variadic_union][invoke_variadic_union][ptr_variadic_union][make_variadic_union]")
{
  ...
  static_assert(
      invoke_variadic_union<bool, U1>(b1, 0, std::in_place, []<typename T>(std::in_place_type_t<T>, auto i) -> bool {
  ...
  static_assert(invoke_variadic_union<int, U2>(b2, 1, std::in_place,
  ...
  static_assert(invoke_variadic_union<int, U3>(b3, 2, std::in_place,
                                               []<typename T>(std::in_place_type_t<T>, auto i) -> int {
  ...
  static_assert(invoke_variadic_union<int, U4>(b4, 3, std::in_place,
                                               []<typename T>(std::in_place_type_t<T>, auto i) -> int {
  ...
  static_assert(invoke_variadic_union<int, U5>(b5, 4, std::in_place,
                                               []<typename T>(std::in_place_type_t<T>, auto i) -> int {
...
TEST_CASE("variadic_unionc invoke only", "[variadic_union][invoke_variadic_union]")
{
  ...
  WHEN("size == 1")
  {
    ...
    static_assert(std::is_same_v<void, decltype(invoke_variadic_union<void, type>(v0, 0, std::in_place, fn2L))>);
    ...
    static_assert(std::is_same_v<int, decltype(invoke_variadic_union<int, type>(v0, 0, std::in_place, fn2))>);
    static_assert(std::is_same_v<long, decltype(invoke_variadic_union<long, type>(v0, 0, std::in_place, fn2))>);
    ...
    static_assert(invoke_variadic_union<int, type>(a, 0, std::in_place, fnAll) == 2);

    CHECK(invoke_variadic_union<int, type>(v0, 0, fn1) == 42);
    CHECK(invoke_variadic_union<int, type>(v0, 0, std::in_place, fn2) == 84);
    auto const before = total;
    invoke_variadic_union<void, type>(v0, 0, fn1L);
    CHECK(total == before + 42);
    invoke_variadic_union<void, type>(v0, 0, std::in_place, fn2L);
  ...
  WHEN("size == 2")
  {
    ...
    static_assert(std::is_same_v<void, decltype(invoke_variadic_union<void, type>(std::declval<type>(), 0,
                                                                                  std::in_place, fn2L))>);
    ...
    static_assert(
        std::is_same_v<int, decltype(invoke_variadic_union<int, type>(std::declval<type>(), 0, std::in_place, fn2))>);
    static_assert(
        std::is_same_v<long, decltype(invoke_variadic_union<long, type>(std::declval<type>(), 0, std::in_place, fn2))>);
    ...
    WHEN("v1 set")
    {
      ...
      CHECK(invoke_variadic_union<short, type>(v1, 1, std::in_place, fn2) == 52);
      auto const before = total;
      invoke_variadic_union<void, type>(v1, 1, fn1L);
      CHECK(total == before + 26);
      invoke_variadic_union<void, type>(v1, 1, std::in_place, fn2L);
  ...
  WHEN("size == 3")
  {
    ...
    WHEN("v2 set")
    {
      ...
      CHECK(invoke_variadic_union<long, type>(v2, 2, std::in_place, fn2) == 24);
      auto const before = total;
      invoke_variadic_union<void, type>(v2, 2, fn1L);
      CHECK(total == before + 12);
      invoke_variadic_union<void, type>(v2, 2, std::in_place, fn2L);
  ...
  WHEN("size == 4")
  {
    ...
    WHEN("v3 set")
    {
      ...
      CHECK(invoke_variadic_union<int, type>(v3, 3, std::in_place, fn2) == 15);
      auto const before = total;
      invoke_variadic_union<void, type>(v3, 3, fn1L);
      CHECK(total == before + 7);
      invoke_variadic_union<void, type>(v3, 3, std::in_place, fn2L);
  ...
  WHEN("size == 5")
  {
    ...
    WHEN("more set")
    {
      ...
      CHECK(invoke_variadic_union<int, type>(v4, 4, std::in_place, fn2) == 3);
      auto const before = total;
      invoke_variadic_union<void, type>(v4, 4, fn1L);
      CHECK(total == before + 1);
      invoke_variadic_union<void, type>(v4, 4, std::in_place, fn2L);
